...
import s1 from "@/assets/sarita-1.jpg";
import s2 from "@/assets/sarita-2.jpg";
import s3 from "@/assets/sarita-3.jpg";
import s4 from "@/assets/sarita-4.jpg";
import pano from "@/assets/sarita-360.jpg";

const slides = [
  { src: s1, label: "Living" },
  { src: s2, label: "Kitchen" },
  { src: s3, label: "Bedroom" },
  { src: s4, label: "Dining" },
];
