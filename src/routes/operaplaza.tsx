...
import detailsImg from "@/assets/OperaPlaza/4.jpeg";
import blueprint from "@/assets/OperaPlaza/4.jpg";
import showerImg from "@/assets/OperaPlaza/6.jpg";
...
const projectImages = [
  ...
  },
  {
    ...
    // Ajuste para mostrar la imagen completa sin recortes
...
function ProjectImage({ 
  ...
  return (
    ...
    >
      ...
      <div className={`${isRight ? 'lg:order-2' : 'lg:order-1'} relative overflow-hidden rounded-sm bg-black/5 dark:bg-white/5 w-full flex items-center justify-center`}>
        <div className={`parallax-image relative ${image.aspectRatio} w-full overflow-hidden transition-transform duration-700`}>
          <img
            src={image.src}
            alt={image.alt}
            loading="lazy"
            className={`h-full w-full ${image.objectFit} transition-transform duration-700 hover:scale-105`}
          />
          {/* Badge superpuesto */}
...
// Sección del patrocinador de la regadera
function ShowerSponsorSection() {
  return (
    <section className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 my-8">
      <div className="p-8 sm:p-12 md:p-16 rounded-sm bg-muted/20 border border-border/40 relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="relative overflow-hidden rounded-sm bg-muted/30 aspect-square sm:aspect-[4/3] lg:aspect-square flex items-center justify-center">
            <img
              src={showerImg}
              alt="Featured Antique Brass Shower System"
              loading="lazy"
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-6">
              Elevate your daily ritual with our featured vintage-inspired shower system. Crafted from solid brass with an exquisite antique finish, this standout fixture seamlessly unites classical European elegance with modern precision engineering. Designed to deliver an effortless, immersive rainfall experience, it serves as the ultimate center-piece for sophisticated high-end bathroom remodels.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-border/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold">Luxurious Rain Flow</p>
                  <p className="text-[11px] text-muted-foreground">Optimal pressure distribution</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <ShieldCheck className="h-5 w-5 text-accent flex-shrink-0" />
                <div>
                  <p className="text-xs font-semibold">Solid Brass Build</p>
                  <p className="text-[11px] text-muted-foreground">Premium corrosion resistance</p>
                </div>
              </div>
            </div>
          </div>
